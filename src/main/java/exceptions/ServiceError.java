...
public class ServiceError extends BaseObject {
	...
	/**
	 * Fehler wenn eine Entity in der Datenbank nicht gefunden werden kann.
	 * 
	 * @param entityName
	 *            Name der Entität.
	 * @param entityId
	 *            Gesuchte Id.
	 * 
	 * @return Der ServiceError.
	 */
	@SuppressWarnings("unchecked")
	public static ServiceError EntityNotFoundException(String entityName, Object entityId) {
		return new ServiceError(400, 4, "%entityName% with id %entityId% not found.",
				Lists.newArrayList( //
						Pair.of("entityName", StringUtils.capitalize(entityName)), //
						Pair.of("entityId", entityId.toString())));
	}
